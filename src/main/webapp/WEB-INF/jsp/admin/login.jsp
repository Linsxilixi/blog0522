...
<head>
    ...
    <style>
        #myCarousel {
            ...
            z-index: 999;
            display: inline;
            position: relative; /* 必须加这一行，使内部的 absolute 生效 */
            overflow: hidden;   /* 防止指示点跑出轮播区域 */
        }

        .carousel-indicators {
            position: absolute; /* 关键！让它定位到底部 */
            bottom: 10px;
            left: 50%;
        ...
        .carousel-indicators .active {
            background-color: #000; /* 高亮当前页的指示点 */
        }
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="/static/img/82839-106.jpg" alt="第一张">
        </div>
        <div class="item">
            <img src="/static/img/105905-106.jpg" alt="第二张">
        </div>
        <div class="item">
            <img src="/static/img/296494-106.jpg" alt="第三张">
        </div>
